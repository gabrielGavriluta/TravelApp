...
public class MyTripsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerViewMyTrips = view.findViewById(R.id.recyclerViewMyTrips);
        recyclerViewMyTrips.setHasFixedSize(true);
        recyclerViewMyTrips.setLayoutManager(new LinearLayoutManager(getContext()));
        recyclerViewMyTrips.addOnItemTouchListener(new RecyclerTouchListener(getContext(),
                recyclerViewMyTrips, new TripLocationClickListener() {
            @Override
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                tripAdapter = new TripAdapter(getContext(), myTrips);
                recyclerViewMyTrips.setAdapter(tripAdapter);
            }
